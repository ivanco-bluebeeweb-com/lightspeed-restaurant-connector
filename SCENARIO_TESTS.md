# PST Testing Scenarios for Lightspeed Restaurant Connector

## Part A: Authentication & Connectivity Verification
- **Scenario A1: Valid Credential Connect**: `connect_lightspeed_restaurant_connector` saves token and validates endpoint.
...
- **Scenario C1: Connection Lifecycle**: Clean disconnect via `disconnect_lightspeed_restaurant_connector` without lingering secrets.
