"""Panel UI for Lightspeed Restaurant Connector following UI_INTERFACE_STANDARD.md."""
...
def _help_modal() -> ui.UINode:
    return ui.Modal(
        ...
        children=[
            ui.Text(
                "1. Sign in to your Lightspeed Restaurant dashboard and navigate to API/Integration settings.\n"
...
async def main_panel(ctx) -> ui.UINode:
    ...
    return ui.Stack(
        ...
        gap=2,
        children=[
            ui.Heading("Lightspeed Restaurant Connector", level=3),
            ui.Text("Connect and manage your Lightspeed Restaurant workspace.", variant="caption"),
            ui.Divider(),
            form,
            ui.Divider(),
            _help_modal(),
