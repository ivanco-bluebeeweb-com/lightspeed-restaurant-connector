"""Settings panel for Lightspeed Restaurant Connector."""
from __future__ import annotations
from imperal_sdk import ui
from app import ext

@ext.panel("__lightspeed_restaurant_settings", slot="center")
async def settings_panel(ctx) -> ui.UINode:
    disconnect_form = ui.Form(
        # id=lightspeed_restaurant_form",
        submit_label="Disconnect Active Account",
        action=ui.Call("disconnect_lightspeed_restaurant"),
        children=[
    ...
    return ui.Stack(
        children=[
            ui.Heading("Lightspeed Restaurant Settings & Accounts", level=2),
